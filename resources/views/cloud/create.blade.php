<x-guest-layout>
    ...
    <form method="POST" action="{{ route('cloud.store') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nextcloud_url" name="nextcloud_url" type="text" class="mt-1 block w-full" :value="old('nextcloud_url')" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nextcloud_username" name="nextcloud_username" type="text" class="mt-1 block w-full" :value="old('nextcloud_username')" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nextcloud_password" name="nextcloud_password" type="password" class="mt-1 block w-full" :value="old('nextcloud_password')" />
